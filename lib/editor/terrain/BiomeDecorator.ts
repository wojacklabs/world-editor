...
export class BiomeDecorator {
   ...
   *
   * NOTE:
   * - BiomeDecorator is intentionally scoped to water and future biome-only decals.
   * - Runtime vegetation (grass/pebble/rock/sandRock) is generated by FoliageSystem.
   * - Tree/Bush generation remains in PropManager (props workflow), not biome workflow.
   */
  rebuildAll(): void {
